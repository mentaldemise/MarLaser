 ...
 */
//See if this stops the no-fire on rapid shake?
...
#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX] instead of directly
    ...
    #define SPEED_POWER_STARTUP           0    // The default value for speed power when M3 is called without arguments
